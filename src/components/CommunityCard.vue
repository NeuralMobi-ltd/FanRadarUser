<template>
  ...
  >
    ...
    <div class="relative h-32">
      ...
      <!-- Community Avatar/Logo positioned at bottom right -->
      <div class="absolute bottom-0 right-0 m-3">
        <img 
          :src="community.logo || community.avatar || community.image" 
          :alt="community.name || community.title" 
    ...
    <div class="p-4">
      ...
      <div class="flex items-center justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-400">
          {{ community.members || community.memberCount }} members
        </span>
        <button 
          :class="[
...
const fandomHandle = computed(() => {
  return (props.community.name || props.community.title)
    ?.toLowerCase()
    .replace(/\s+/g, '-')
    .replace(/[^a-z0-9-]/g, '')
})
